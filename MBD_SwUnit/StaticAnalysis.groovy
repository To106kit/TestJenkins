 ...
 *
 * This job is for running "StaticAnalysis" of mdl_static_check process. It consists of two stages, 
 ...
 * to be executed by StaticAnalysis, and executes it on them. Then, upload the artifacts to the specified
                    ...
                    try {
                        ...
                        for (searchResult in searchResults) {
                            ...
                            try {
                                ...
                                staticAnalysis(newYamlConfig.parameters)
                            } catch (CICTFrameworkException e) {
                                if (e.id.equals('0005600003')) {   // MATLAB returned nonzero exit
                                    ...
                                    if (quotientRetVal == 1) {   // Warning => UNSTABLE
                                        ...
                                        printMessage('0008300001', searchResult.fileName)
                                ...
                                if (fileExists('qac_result')) {
                                    fileOperations([
                                        folderCopyOperation(sourceFolderPath:'qac_result',destinationFolderPath:"Result\\${searchResult.basename}"),
                                        folderDeleteOperation(folderPath:'qac_result')
                                    ])
                                }
                            }
                        }
