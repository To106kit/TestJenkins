 ...
 * << CompileCheck.groovy >>
 *
 * This job is for running "CompileCheck" of mdl_coding process. It consists of two stages, 
 ...
 * to be executed by CompileCheck, and executes it on them. Then, upload the artifacts to the specified
                ...
                script {
                    ...
                    try {
                        ...
                        for (searchResult in searchResults) {
                            ...
                            try {
                                compilecheck(newYamlConfig.parameters)
                            } catch (CICTFrameworkException e) {
                                if (e.id.equals('0005600003')) {   // MATLAB returned nonzero exit
                                    ...
                                    if (quotientRetVal == 1) {   // Warning => UNSTABLE
                                        ...
                                        printMessage('0008100001', searchResult.fileName)
                                ...
                                if (fileExists('CompileCheckResult')) {
                                    fileOperations([
                                        folderCopyOperation(sourceFolderPath:'CompileCheckResult',destinationFolderPath:"Result\\${searchResult.basename}"),
                                        folderDeleteOperation(folderPath:'CompileCheckResult')
                                    ])
                                }
                            }
                        }
