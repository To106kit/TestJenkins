 ...
 * << CodeGen.groovy >>
 *
 * This job is for running "CodeGen" of mdl_coding process. It consists of two stages, 
 ...
 * to be executed by CodeGen, and executes it on them. Then, upload the artifacts to the specified
...
pipeline {
    ...
    stages {
        ...
        //                     try {
        //                         // Execute CodeGen
        //                         codeGen(newYamlConfig.parameters)
        //                     } catch (CICTFrameworkException e) {
        ...
        //                                 printMessage('0008600001', searchResult.fileName)
        ...
        //                         String t_post = 'code'
        //                         if (fileExists("${searchResult.fileDir}\\${searchResult.basename}_${t_post}")) {
        //                             fileOperations([
        //                                 folderRenameOperation(source:"${searchResult.fileDir}\\${searchResult.basename}_${t_post}", destination:"Result\\${searchResult.basename}\\${searchResult.basename}_${t_post}")
        //                             ])
        //                         }
        //                     }
        //                 }
