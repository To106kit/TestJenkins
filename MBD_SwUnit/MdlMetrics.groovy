 ...
 * << MdlMetrics.groovy >>
 *
 * This job is for running "MdlMetrics" of mdl_design process. It consists of two stages, 
 ...
 * to be executed by MdlMetrics, and executes it on them. Then, upload the artifacts to the specified
                ...
                script {
                    ...
                    try {
                        ...
                        for (searchResult in searchResults) {
                            ...
                            try {
                                // Execute MdlMetrics
                                mdlMetrics(newYamlConfig.parameters)
                            } catch (CICTFrameworkException e) {
                                if (e.id.equals('0005600003')) {   // MATLAB returned nonzero exit
                                    ...
                                    if (quotientRetVal == 1) {   // Warning => UNSTABLE
                                        ...
                                        printMessage('0009000001', searchResult.fileName)
                                ...
                                fileOperations([
                                    ...
                                    fileCopyOperation(includes:"${searchResult.fileDir}\\ResultModelMetrics.xlsx", targetLocation:"Result\\${searchResult.basename}", flattenFiles:true)
                                ])
                            }
                        }
