 ...
 * << MdlSet.groovy >>
 *
 * This job is for running "MdlSet" of mdl_design process. It consists of two stages, 
 ...
 * to be executed by MdlSet, and executes it on them. Then, upload the artifacts to the specified
...
// Read SharedLibrary
@Library('SPIFWLibrary@R2021.B.02')
                ...
                script {
                    ...
                    try {
                        ...
                        for (searchResult in searchResults) {
                            ...
                            try {
                                // Execute MdlSet
                                mdlSet(newYamlConfig.parameters)
                            } catch (CICTFrameworkException e) {
                                if (e.id.equals('0005600003')) {   // MATLAB returned nonzero exit
                                    ...
                                    if (quotientRetVal == 1) {   // Warning => UNSTABLE
                                        ...
                                        printMessage('0008200001', searchResult.fileName)
                                ...
                                fileOperations([
                                    ...
                                    folderCopyOperation(sourceFolderPath:searchResult.fileDir, destinationFolderPath:"Result\\${searchResult.basename}"),
                                ])
                            }
                        }
                        ...
                        mbdCommonProcessing.publishHTMLReport(yamlConfig, '**\\report.html', '')
