...
/**
 * << StaticResultSort.groovy >>
 *
 * This job is for running "StaticResultSort" of mdl_static_check process. It consists of two stages, 
 ...
 * to be executed by StaticResultSort, and executes it on them. Then, upload the artifacts to the specified
...
def yamlConfig
def processName = 'mdl_static_check'
def toolName = 'StaticResultSort'
                ...
                script {
                    ...
                    try {
                        ...
                        for (searchResult in searchResults) {
                            ...
                            try {
                                // Execute StaticResultSort
                                staticResultSort(newYamlConfig.parameters)
                            } catch (CICTFrameworkException e) {
                                if (e.id.equals('0005600003')) {   // MATLAB returned nonzero exit
                                    ...
                                    if (quotientRetVal == 1) {   // Warning => UNSTABLE
                                        ...
                                        printMessage('0008400001', searchResult.fileName)
                                ...
                                if (fileExists('sort_result')) {
                                    fileOperations([
                                        folderCopyOperation(sourceFolderPath:'sort_result',destinationFolderPath:"Result\\${searchResult.basename}"),
                                        folderDeleteOperation(folderPath:'sort_result')
                                    ])
                                }
                            }
                        }
